#!/bin/bash
set -e
git remote add upstream https://github.com/AnaviTechnology/anavi-fume-extractor-sw.git
git fetch upstream
git rebase upstream/master
git remote set-url origin git@github.com:dangherve/anavi-fume-extractor-sw.git
